    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-5 mb-5 text-left">
          <p className="text-white font-semibold mb-1">Pay with PayPal to upgrade instantly</p>
          <p className="text-slate-400 text-sm mb-4">
            Send payment to <span className="text-white font-medium">@write2dinakar</span> on PayPal.
            Include your <strong className="text-slate-200">church name</strong> and <strong className="text-slate-200">plan chosen</strong> in the note.
            Access is restored within a few hours.
          </p>
        ...
        <div className="space-y-3">
          ...
          <Button asChild variant="outline" className="w-full border-slate-700 text-slate-300 hover:bg-slate-800 h-12">
            <a href="mailto:admin@taborsynergy.com?subject=ChurchConnect upgrade&body=Church name: %0APlan: %0AQuestion: ">
